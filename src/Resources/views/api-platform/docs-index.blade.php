...
<html>
<head>
    <title>zatona-eg-api Documentation</title>
    <meta charset="utf-8"/>
...
<body>
    <section class="bs-download-header">
        <div class="container ">
            <div class="header">
                <div class="logo">
                    <img src="{{ asset('themes/admin/default/assets/images/top-logo.svg') }}" alt="Bagisto API Logo" width="150" height="60">
                </div>
                <h1>zatona-eg-api</h1>
            ...
            <div class="footer">
                <p>zatona-eg-api Documentation • Powered by <a href="https://api-platform.com" target="_blank">API Platform</a> & <a href="https://app.zatona-eg.com" target="_blank">zatona-eg-api</a></p>
            </div>
        </div>
    </section>
</body>
