...
/**
 * POST /api/admin/settings/data-transfer/imports/{id}/link
 * + linkAdminSettingsDataTransferImportLink mutation.
 *
 * Links one processed batch and returns { stats, import }. Permission:
 * settings.data_transfer.imports.edit.
 */
#[ApiResource(
    routePrefix: '/api/admin',
    shortName: 'AdminSettingsDataTransferImportLink',
    normalizationContext: ['skip_null_values' => false],
    output: AdminSettingsDataTransferImport::class,
    operations: [
        new Post(
            uriTemplate: '/settings/data-transfer/imports/{id}/link',
            ...
            openapi: new Model\Operation(
                ...
                summary: 'Link an import batch',
                description: 'Links the next processed batch and returns stats + the refreshed import. Permission: settings.data_transfer.imports.edit.',
                ...
                responses: [
                    '200' => new Model\Response(description: 'Batch linked; stats + refreshed import.'),
    ...
    graphQlOperations: [
        new Mutation(
            ...
            input: AdminSettingsDataTransferImportActionInput::class,
            processor: AdminSettingsDataTransferImportActionProcessor::class,
            description: 'Link an import batch.',
        ),
    ],
)]
class AdminSettingsDataTransferImportLink
{
